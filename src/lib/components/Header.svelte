  ...
  <div class="flex flex-row justify-between">
    ...
    <!-- Logo link -->
      <a sveltekit:prefetch href="/" class="mr-6">
        <svg class="h-12 w-12 flex-shrink-0 {isDark ? 'text-white' : 'text-slate-500'} transition-colors duration-150 ease-in-out" id="logo" fill="none" viewBox="0 0 115 36" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pt-3 flex flex-row space-x-1">
      <svg class="h-5 w-5 transition-colors duration-150 ease-in-out {isDark ? 'text-slate-700' : 'text-slate-500'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
      </svg>
      <!-- Enabled: "bg-indigo-600", Not Enabled: "bg-slate-200" -->
      <button type="button" class="relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring focus:ring-sky-300 dark:focus:ring-yellow-400 {isDark ? 'bg-slate-700' : 'bg-slate-200'}" aria-pressed="false"
      ...
      <svg class="h-5 w-5 transition-colors duration-150 ease-in-out {isDark ? 'text-white' : 'text-slate-300'}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
