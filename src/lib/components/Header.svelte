  ...
  <div class="flex flex-row justify-between">
    ...
    <!-- Logo link -->
      <a sveltekit:prefetch href="/" class="mr-6">
        <svg class="h-12 w-12 flex-shrink-0 text-slate-600 dark:text-white transition-colors duration-150 ease-in-out" id="logo" fill="none" viewBox="0 0 115 36" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pt-3 flex flex-row space-x-1">
      <!-- Sunny svg -->
      <svg class="h-6 w-6 transition-colors duration-150 ease-in-out text-amber-500 dark:text-slate-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      <!-- Cloudy svg -->
      <svg class="h-6 w-6 transition-colors duration-150 ease-in-out text-slate-300 dark:text-white" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 20 20" fill="currentColor">
