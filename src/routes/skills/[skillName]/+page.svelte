...
<div class="max-w-7xl mx-auto pt-20 px-6 lg:px-8">
	...
	<div class="mx-20 lg:mx-40">
		<div class="lg:flex lg:flex-row lg:justify-around">
				...
				<div class="text-slate-900 dark:text-white transition-colors duration-150 ease-in-out">
					<div class="grid grid-cols-3 grid-rows-3 gap-5 px-auto lg:gap-10">
						{#each $skills as skill}
							<a
								href="/skills/{skill.icon}"
								class="aspect-w-1 aspect-h-1 bg-slate-200 dark:bg-slate-900 border-2 border-slate-200 dark:border-white rounded-lg transition-all duration-300 ease-in-out"
							>
			...
			<div class="text-center lg:text-left mt-20 lg:mt-5 lg:w-96">
				...
				<div>
					<h2
						class="mt-5 text-3xl font-bold text-slate-900 dark:text-white transition-colors duration-150 ease-in-out"
					>
						{selectedSkill.title}
					</h2>
					<h3
						class="text-2xl font-normal text-slate-900 dark:text-white transition-colors duration-150 ease-in-out"
					>
	...
	<!-- Video section -->
	<div
		class="my-32 h-showreel bg-slate-100 dark:bg-gray-800 rounded-lg transition-colors duration-150 ease-in-out"
	/>
</div>
